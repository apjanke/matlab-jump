classdef JarExtInspector
  
  properties (Constant)
    % These are SHA1s that I assembled manually by downloading the distributions and
    % running "shasum -a 1" on their JARs.
    knownShas = cell2table({
      '1136d197e2755bbde296ceee217ec5fe2917477b', 'Apache Xerces-J', 'Apache', '2.9.1', 'xercesImpl.jar'
      '90b215f48fe42776c8c7f6e3509ec54e84fd65ef', 'Apache Xerces-J', 'Apache', '2.9.1', 'xml-apis.jar'
      '9161654d2afe7f9063455f02ccca8e4ec2787222', 'Apache Xerces-J', 'Apache', '2.10.0', 'xercesImpl.jar'
      '3789d9fada2d3d458c4ba2de349d48780f381ee3', 'Apache Xerces-J', 'Apache', '2.10.0', 'xml-apis.jar'
      '9bb329db1cfc4e22462c9d6b43a8432f5850e92c', 'Apache Xerces-J', 'Apache', '2.11.0', 'xercesImpl.jar'
      '3789d9fada2d3d458c4ba2de349d48780f381ee3', 'Apache Xerces-J', 'Apache', '2.11.0', 'xml-apis.jar'
      'f02c844149fd306601f20e0b34853a670bef7fa2', 'Apache Xerces-J', 'Apache', '2.12.0', 'xercesImpl.jar'
  ...
  methods
    ...
    function [out,fullResults] = listJarExtInfo(this) %#ok<MANU>
      ...
      %
      % [out,fullResults] = obj.listJarExtInfo
      %
      ...
      % Developer note: The code in here avoids using string and categorical arrays,
      % so it will still work on older versions of Matlab.
